            ...
            children: [
              ...
              Lottie.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  return const Icon(Icons.shopping_bag, size: 100, color: maroonColor);
                },
              ),
              ...
              Text(
                'Tampil percaya diri dengan koleksi busana pilihan. Temukan outfit casual, formal, hingga trendy yang bikin kamu makin kece setiap hari.',
                textAlign: TextAlign.center,
                style: GoogleFonts.outfit(
                  fontSize: 14,
